...
out_dirs1=/$ex_name"_out1"
out_dirs2=/$ex_name"_out2"

args="$data_dirs/data.txt $out_dirs"
local_args="$local_data_dir/BoughtBooks.txt $local_data_dir/Books.txt \
                            $base_dir/$out_dirs1 $base_dir/$out_dirs2 0.1"
